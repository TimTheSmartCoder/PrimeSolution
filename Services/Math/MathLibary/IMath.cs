...
namespace MathLibary
{
    public interface IMath
    {
        ...
        /// <returns>The area of the triangle roundet to two decimals.</returns>
        ...
        /// <returns>The circumference of the triangle roundet to two decimals.</returns>
        ...
        /// <returns>The hypotenuse of the triangle roundet to two decimals.</returns>
        ...
        /// <returns>The area of the circle roundet to two decimals.</returns>
        ...
        /// </summary>
        /// <param name="radius">Radius of the circle.</param>
        /// <returns>The circumference of the circle roundet to two decimals.</returns>
        /// <exception cref="ArgumentException">If radius is 0 or lower.</exception>
        ...
        /// <returns>The addition result roundet to two decimals.</returns>
        ...
        /// <returns>The subtracted result roundet to two decimals.</returns>
        /// <exception cref="ArgumentException">If numbers is empty.</exception>
        Task<double> SubtracktionAsync(params double[] numbers);

        /// <summary>
        /// Multiplies a numbers of doubles together asynchronous.
        /// </summary>
        /// <param name="numbers">A list of doubles to be multiplied.</param>
        /// <returns>The multiplied result roundet to two decimals.</returns>
        /// <exception cref="ArgumentException">If numbers is empty.</exception>
        ...
        /// <returns>The divided result roundet to two decimals.</returns>
